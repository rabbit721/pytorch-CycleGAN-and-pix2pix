...
class ResnetGeneratorSharedLayer(nn.Module):
    ...
    def __init__(self, model_shared, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
